...
export default function ProductContainer() {
    ...
    // استفاده از useMediaQuery برای چک کردن سایز صفحه
    ...
    return (
        <div style={{backgroundImage: 'linear-gradient(178.1deg, rgb(60, 55, 106) 8.5%, rgb(23, 20, 69) 82.4%)'}} className={`w-full min-h-screen grid gap-8 p-4 md:px-20 lg:px-40
