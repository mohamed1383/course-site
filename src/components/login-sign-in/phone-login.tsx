            ...
            <div className="w-[90%] max-w-[500px] h-auto min-h-[500px] rounded-[20px] backdrop-blur-xl bg-[#7AC6D2]/10 border border-[#B5FCCD]/20 shadow-2xl p-8">
                <div className="w-full flex flex-col items-center gap-8">
                    ...
                    <div className="text-center">
                        <h1 className="text-2xl font-bold text-white mb-2">ورود با شماره تلفن</h1>
                    </div>
                    ...
                    <p className="text-white/70">
                        اکانت ندارید؟{' '}
                        <a onClick={() => navigate('/login-page/phone-sign-in')} className="text-[#B5FCCD] hover:text-[#B5FCCD]/80 transition-colors cursor-pointer">
                            ثبت نام
                        </a>
                    </p>
                </div>
